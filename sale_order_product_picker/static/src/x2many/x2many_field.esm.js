    ...
    setup() {
        ...
        onWillStart(async () => {
            if (
                ...
                const relatedModel = "sale.order.line";
                const viewModes = [[false, "list"], [false, "kanban"], [false, "form"]];
                const views = await this.viewService.loadViews({context: this.props.context, resModel: relatedModel, views: viewModes})
                const activeField = {
                    fields: views.fields,
                    views: views.views,
                ...
                const subViewActiveActions = this.props.views[this.props.viewMode].activeActions;
